...
<div class="col-lg-8 col-md-10 mx-auto">
   <div class="row">
      <div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
         <h2><b>{{$insurance->company_name}}</b><span style="float:right;"> ${{$insurance->price}}</span></h2>
      </div>
      <div class="col-md-12">
         <div class="w3-content w3-display-container">
            <img class="mySlides" src="/image/admin/insurances/{{$insurance->picture}}" style="width:980px;height: 600px;">
            <button class="w3-button w3-black w3-display-left" onclick="plusDivs(-1)">&#10094;</button>
            <button class="w3-button w3-black w3-display-right" onclick="plusDivs(1)">&#10095;</button>
         </div>
         <div class="col-md-12 hotel-single mt-4 mb-5 pl-0">
            <p class="details">{{$insurance->detail}}</p>
            ...
            <div class="row box">
               <div class="col-lg-6 col-md-6 col-sm-6 col-6">
                  ...
                  <ul class="hotelInfo mx-auto">
                     <li><span class="icon" style="color: #f9be37;"><span class="icon-star"></span></span>&nbsp&nbspHotel Class {{$insurance->class}}</li>
                     <li><span class="icon" style="color: #f9be37;"><span class="icon-person"></span></span>&nbsp&nbspNumber of persons {{$insurance->no_of_persons}}</li>
                     <li><span class="icon" style="color: #f9be37;"><span class="icon-hotel"></span></span>&nbsp&nbspRoom type {{$insurance->room_type}}</li>
                     <li><a href="{{url('/insurance',$insurance->id)}}"> 
